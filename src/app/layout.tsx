...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Kroll & Kroll Bauelemente – Fenster, Türen & Wintergärten",
    description:
      "Maßgefertigte Bauelemente vom Fachmann seit 1992. Berlin, Brandenburg, Niedersachsen.",
    images: [OG_IMAGE],
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="de" className={`${inter.variable} antialiased`}>
      ...
      <body
        className="min-h-screen flex flex-col bg-[#F7F6F3] text-[#121210]"
